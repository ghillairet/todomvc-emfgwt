...
public class ToDoCell extends AbstractCell<Item> implements CellView {
	...
	@Override
	public boolean isEditing(Context context, Element parent, Item value) {
		return isEditing(value);
	}

	@Override
	public void onBrowserEvent(Context context, Element parent, Item value, NativeEvent event, ValueUpdater<Item> valueUpdater) {
	 ...
	 */
	private void commitEdit(Element parent, Item value) {
		InputElement input = getInputElement(parent);
	 ...
	 */
	private void beginEdit(Context context, Element parent, Item value) {
		editingItem = value;
	 ...
	 */
	private void endEdit(Context context, Element parent, Item value) {
		editingItem = null;
		renderCell(context, parent, value);
	}
	 ...
	 */
	private void renderCell(Context context, Element parent, Item value) {
	 ...
	 */
	private boolean isEditing(Item item) {
