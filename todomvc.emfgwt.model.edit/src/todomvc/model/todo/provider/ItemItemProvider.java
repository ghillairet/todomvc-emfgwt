...
/**
 * This is the item provider adapter for a {@link todomvc.model.todo.Item} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TodoPackage.Literals.ITEM__TITLE,
				 true,
				 false,
				 false,
	...
	protected void addDonePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Item_done_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Item_done_feature", "_UI_Item_type"),
				 TodoPackage.Literals.ITEM__DONE,
				 true,
				 false,
				 false,
